...
# modified from https://github.com/NVIDIA/Stable-Diffusion-WebUI-TensorRT/blob/main/control_unet.py
# STATUS: draft
...
def aligned_adding(base, x, require_channel_alignment):
	...
	if xh > 1 or xw > 1:
		if base_h != xh or base_w != xw:
			# logger.warn("ControlNet finds unexpected mis-alignment in tensor shape.")
...
class ControlUNet(UNetModel):
	def forward(
		self,
		x, timesteps=None, context=None, y=None,
		control_0=None, control_1=None, control_2=None, control_3=None, control_4=None,
		control_5=None, control_6=None, control_7=None, control_8=None, control_9=None,
		control_10=None, control_11=None, control_12=None,
		**kwargs
	):
		control = [
		...
		if control_12 is not None:
			control.extend([control_10, control_11, control_12])
